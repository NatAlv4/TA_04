...
- Finalmente se desarrollara la funcion de Geolocalizacion que permitira al usuario las posibilidad de que cuando acceda al mapa de su ciudad o zona corresponiente, se indique     la disponibilidad y cercania de cada uno de los centros hospitalarios, en especian, en la medida de lo posible, los especializados en camcer, para que asi, a la hora de desplazarse, ya sea en caso de emergencia, citas medicas, u otro tipo de asunto, haya una claridad de la ubicación de estos tipos de establecimiento.
